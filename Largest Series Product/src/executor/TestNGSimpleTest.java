...
import keywords.LargestSeriesProductCalculator;
...
//
//    
//    @Test(expectedExceptions = {IllegalArgumentException.class}, expectedExceptionsMessageRegExp ="Series length must be less than or equal to the length of the string to search.")
...
//    }
    ...
    @Test(expectedExceptions = {IllegalArgumentException.class}, expectedExceptionsMessageRegExp ="String to search may only contains digits.")
    public void testStringToSearchContainingNonDigitCharacterIsRejected() {
    	new LargestSeriesProductCalculator("1234a5");
    }

    
//    @Test(expectedExceptions = {IllegalArgumentException.class}, expectedExceptionsMessageRegExp ="Series length must be non-negative.")
...
//
//    
//    @Test(expectedExceptions = {IllegalArgumentException.class}, expectedExceptionsMessageRegExp ="String to search must be non-null.")
